...
class IPFSApiTest {
    ...
    @Test
    fun testAddFileToIPFSReturn200() =
        runTest {
    ...
    @Test
    fun testAddFileToIPFSReturn200WithFailData() =
        runTest {
    ...
    @Test
    fun testAddFileToIPFSReturn400() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_ADD,
    ...
    @Test
    fun testRelayToIPFSGatewayReturn200WithFailData() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_GATEWAY,
                HttpStatusCode.OK,
    ...
    @Test
    fun testRelayToIPFSGatewayReturn400() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_GATEWAY,
                HttpStatusCode.BadRequest,
    ...
    @Test
    fun testPinIPFSObjectReturn200WithFailData() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_PIN_ADD,
                HttpStatusCode.OK,
    ...
    @Test
    fun testPinIPFSObjectReturn400() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_PIN_ADD,
                HttpStatusCode.BadRequest,
    ...
    @Test
    fun testUnpinIPFSObjectReturn200WithFailData() =
        runTest {
            testApiWithBadRequest(
    ...
    @Test
    fun testUnpinIPFSObjectReturn400() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_PIN_REMOVE,
                HttpStatusCode.BadRequest,
    ...
    @Test
    fun testGetPinnedObjectDetailsReturn200WithFailData() =
        runTest {
            testApiWithBadRequest(
    ...
    @Test
    fun testGetPinnedObjectDetailsReturn400() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_PIN_DETAILS,
                HttpStatusCode.BadRequest,
    ...
    @Test
    fun testGetListPinnedObjectsReturn200WithFailData() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_PIN_LIST,
                HttpStatusCode.OK,
    ...
    @Test
    fun testGetListPinnedObjectsReturn400() =
        runTest {
            testApiWithBadRequest(
                PATH_IPFS_PIN_LIST,
                HttpStatusCode.BadRequest,
